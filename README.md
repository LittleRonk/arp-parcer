# ARP packet parcer in C

## Limitations

The parcer only supports classic ARP over Ethernet/IPv4:
...
int main(void)
{
    ...
    if (parce_arp(test_arp_packet, sizeof(test_arp_packet), &packet_1) == ARP_OK)
        print_arp(&packet_1);
